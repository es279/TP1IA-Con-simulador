...
//    	tramosRecorridos.add(position);
        ...
        //Añade la percepción de si hay bloqueos entre dos calles a la lista de bloqueos conocidos
        ...
        for(Integer[] elementoActual : lista) {
        	...
        	if(this.listaBloqueosConocidos.size() == cont) {
        		...
        		//TODO: Interface. Agrega el bloqueo conocido a la simulación grafica
